 ...
 */
@Slf4j
public class UpdateBatchDeleteMethod extends AbstractMethod {
	public UpdateBatchDeleteMethod(String methodName) {
		super(methodName);
	}
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addUpdateMappedStatement(mapperClass, modelClass, "updateDeleteBatch", sqlSource);
    }
